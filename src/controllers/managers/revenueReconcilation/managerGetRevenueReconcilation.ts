...
import revenueReconcilationWrapper from "../../../utils/revenueReconcilation/revenueReconcilationWrapper";
import { Types } from "mongoose";

const managerGetRevenueReconcilation = async (req: Request, res: Response): Promise<Response> => {
    try {
        ...
        let data = await revenueReconcilationWrapper(startDay,days,hotelIds.map(id => new Types.ObjectId(id)),isTable)
...
export default managerGetRevenueReconcilation