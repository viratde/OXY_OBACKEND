...
import getBookingCheckInAnalytics from "../../../utils/bookingAnalytics/getBookingCheckInAnalytics";


const managerGetBookingCheckInAnalyticsController = async (
    req: Request,
    res: Response
): Promise<Response> => {
    ...
    try {
        ...
        const data = await getBookingCheckInAnalytics(startDay, days, isTable, hotelIds.map(hot => new Types.ObjectId(hot)))
...
export default managerGetBookingCheckInAnalyticsController