...
import getBookingCheckOutAnalytics from "../../../utils/bookingAnalytics/getBookingCheckOutAnalytics";


const managerGetBookingCheckOutAnalyticsController = async (
    req: Request,
    res: Response
): Promise<Response> => {
    ...
    try {
        ...
        const data = await getBookingCheckOutAnalytics(startDay, days, isTable, hotelIds.map(hot => new Types.ObjectId(hot)))
...
export default managerGetBookingCheckOutAnalyticsController