...
import getFeedbackAnalytics from "../../../utils/feedbacks/getFeedbackAnalytics";


const getFeedbackAnalyticsController = async (
    req: Request,
    res: Response
) => {
    ...
    try {
        ...
        const data = await getFeedbackAnalytics(startDay, days, isTable, hotelIds.map(hot => new Types.ObjectId(hot)))
...
export default getFeedbackAnalyticsController