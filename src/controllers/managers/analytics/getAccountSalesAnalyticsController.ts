...
import getAccountSalesAnalyticsController from "../../../utils/accountAnalytics/getAccountSalesAnalyticsController";


const managerGetAccountSalesAnalytics = async (
    req: Request,
    res: Response
): Promise<Response> => {
    ...
    try {
        ...
        const data = await getAccountSalesAnalyticsController(startDay, days, isTable, hotelIds.map(hot => new Types.ObjectId(hot)))
...
export default managerGetAccountSalesAnalytics