...
import userAnalytics from "../../../utils/bookingAnalytics/userAnalytics";


const getUsersAnalyticsController = async (
    req: Request,
    res: Response
): Promise<Response> => {
    ...
    try {
        ...
        const data = await userAnalytics(startDay, days, isTable)
...
export default getUsersAnalyticsController