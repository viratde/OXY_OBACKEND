...
import getBookingRevenueAnalytics from "../../../utils/accountAnalytics/getBookingRevenueAnalytics";
import { Types } from "mongoose";
import getBookingSummaryAnalytics from "../../../utils/bookingAnalytics/getBookingSummaryAnalytics";

const managerGetBookingSummaryAnalyticsController = async (
    req: Request,
    res: Response
): Promise<Response> => {
    ...
    try {
        ...
        const data = await getBookingSummaryAnalytics(startDay, days, hotelIds.map(hot => new Types.ObjectId(hot)))
...
export default managerGetBookingSummaryAnalyticsController