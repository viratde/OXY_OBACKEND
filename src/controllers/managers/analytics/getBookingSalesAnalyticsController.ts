...
import getBookingSalesAnalytics from "../../../utils/bookingAnalytics/getBookingSalesAnalytics";


const managerGetBookingSalesAnalytics = async (
    req: Request,
    res: Response
): Promise<Response> => {
    ...
    try {
        ...
        const data = await getBookingSalesAnalytics(startDay, days, isTable, hotelIds.map(hot => new Types.ObjectId(hot)))
...
export default managerGetBookingSalesAnalytics